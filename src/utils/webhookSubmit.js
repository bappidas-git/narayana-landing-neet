...
// =============================================
const WEBHOOK_URL = 'https://connect.pabbly.com/workflow/sendwebhookdata/REPLACE_WITH_YOUR_WEBHOOK_ID';
...
export const submitLeadToWebhook = async (leadData) => {
  ...
  if (DUMMY_MODE || !USE_PABBLY) {
    console.log('[DUMMY MODE] Lead captured:', JSON.stringify(enrichedData, null, 2));
